...
2. **Descrição**  
   Em uma academia, há uma variedade de esportes que são oferecidos para todos os alunos que a frequentam (exemplo: luta, dança, yoga etc).
...
* Mostrar os esportes que estão disponíveis, seus respectivos horários e os instrutores responsáveis;  
* Apresentar o valor de cada esporte;  
* Ter uma área de pagamento dentro do próprio sistema.  
    
5. **Público-Alvo:** instrutores e alunos (clientes da academia).
...
6. A academia tem uma quantidade limitada de salas/esportes que podem ocorrer simultaneamente.
...
5. Conflitos de horário devem ser tratados em tempo real;  
6. A base de dados deve estar sincronizada e consistente;  
7. Eportes simultâneos devem respeitar a capacidade física da academia.
